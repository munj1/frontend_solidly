...
export interface BaseV2TokenInterfaceInterface extends utils.Interface {
    functions: {
...
export interface BaseV2TokenInterface extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BaseV2TokenInterfaceInterface;
