...
export interface BaseV2BribeFactoryInterfaceInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "childInterfaceAddress" | "childSubImplementationAddress" | "createBribe" | "governanceAddress" | "interfaceSourceAddress" | "updateChildInterfaceAddress" | "updateChildSubImplementationAddress"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "createBribe", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "createBribe", data: BytesLike): Result;
...
export interface BaseV2BribeFactoryInterface extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BaseV2BribeFactoryInterfaceInterface;
    ...
    functions: {
        ...
        createBribe(overrides?: Overrides & {
