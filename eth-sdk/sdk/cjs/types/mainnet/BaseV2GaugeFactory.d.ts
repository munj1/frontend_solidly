...
export interface BaseV2GaugeFactoryInterface extends utils.Interface {
    functions: {
...
export interface BaseV2GaugeFactory extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BaseV2GaugeFactoryInterface;
