...
export interface BaseV2FeeDistFactoryInterfaceInterface extends utils.Interface {
    functions: {
        "childInterfaceAddress()": FunctionFragment;
        "childSubImplementationAddress()": FunctionFragment;
        "createFeeDist(address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "childInterfaceAddress" | "childSubImplementationAddress" | "createFeeDist" | "governanceAddress" | "interfaceSourceAddress" | "updateChildInterfaceAddress" | "updateChildSubImplementationAddress"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "createFeeDist", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "createFeeDist", data: BytesLike): Result;
...
export interface BaseV2FeeDistFactoryInterface extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BaseV2FeeDistFactoryInterfaceInterface;
    ...
    functions: {
        ...
        createFeeDist(_pool: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        childInterfaceAddress(overrides?: CallOverrides): Promise<string>;
        childSubImplementationAddress(overrides?: CallOverrides): Promise<string>;
        createFeeDist(_pool: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        governanceAddress(overrides?: CallOverrides): Promise<string>;
        interfaceSourceAddress(overrides?: CallOverrides): Promise<string>;
