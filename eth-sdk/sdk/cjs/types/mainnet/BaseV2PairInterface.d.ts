...
export declare namespace BaseV2PairInterface {
...
export interface BaseV2PairInterfaceInterface extends utils.Interface {
    functions: {
...
export interface BaseV2PairInterface extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BaseV2PairInterfaceInterface;
    ...
    functions: {
        ...
        lastObservation(overrides?: CallOverrides): Promise<[BaseV2PairInterface.ObservationStructOutput]>;
