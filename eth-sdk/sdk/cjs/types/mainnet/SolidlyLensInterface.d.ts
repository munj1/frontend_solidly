...
export declare namespace SolidlyLensInterface {
    ...
    type PositionBribesByTokenIdStruct = {
        ...
        bribes: SolidlyLensInterface.PositionPoolStruct[];
    };
    type PositionBribesByTokenIdStructOutput = [
        BigNumber,
        SolidlyLensInterface.PositionPoolStructOutput[]
    ] & {
        tokenId: BigNumber;
        bribes: SolidlyLensInterface.PositionPoolStructOutput[];
    };
    type PoolStruct = {
        id: PromiseOrValue<string>;
...
export interface SolidlyLensInterfaceInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "bribeAddresByPoolAddress" | "bribeTokensAddressesByBribeAddress" | "bribeTokensAddressesByPoolAddress" | "bribesAddresses" | "bribesPositionsOf(address,address,uint256)" | "bribesPositionsOf(address,address)" | "deployerAddress" | "feeDistAddressByPoolAddress" | "gaugeAddressByPoolAddress" | "gaugesAddresses" | "gaugesFactoryAddress" | "initializeProxyStorage" | "libraryAddress" | "minterAddress" | "ownerAddress" | "poolInfo" | "poolReservesInfo" | "poolsAddresses" | "poolsFactoryAddress" | "poolsInfo" | "poolsLength" | "poolsPositionsOf(address)" | "poolsPositionsOf(address,uint256,uint256)" | "poolsReservesInfo" | "protocolMetadata" | "proxyStorageInitialized" | "routerAddress" | "setOwnerAddress" | "setVeAddress" | "solidAddress" | "veAddress" | "veDistAddress" | "vePositionsOf" | "veTokensIdsOf" | "voterAddress"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "proxyStorageInitialized", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "proxyStorageInitialized", data: BytesLike): Result;
...
export interface SolidlyLensInterface extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: SolidlyLensInterfaceInterface;
    ...
    functions: {
        ...
        "bribesPositionsOf(address,address,uint256)"(accountAddress: PromiseOrValue<string>, poolAddress: PromiseOrValue<string>, tokenId: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[SolidlyLensInterface.PositionPoolStructOutput[]]>;
        "bribesPositionsOf(address,address)"(accountAddress: PromiseOrValue<string>, poolAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[SolidlyLensInterface.PositionBribesByTokenIdStructOutput[]]>;
        ...
        poolInfo(poolAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[SolidlyLensInterface.PoolStructOutput]>;
        poolReservesInfo(poolAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[SolidlyLensInterface.PoolReserveDataStructOutput]>;
        poolsAddresses(overrides?: CallOverrides): Promise<[string[]]>;
        poolsFactoryAddress(overrides?: CallOverrides): Promise<[string]>;
        poolsInfo(overrides?: CallOverrides): Promise<[SolidlyLensInterface.PoolStructOutput[]]>;
        poolsLength(overrides?: CallOverrides): Promise<[BigNumber]>;
        "poolsPositionsOf(address)"(accountAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[SolidlyLensInterface.PositionPoolStructOutput[]]>;
        "poolsPositionsOf(address,uint256,uint256)"(accountAddress: PromiseOrValue<string>, startIndex: PromiseOrValue<BigNumberish>, endIndex: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[SolidlyLensInterface.PositionPoolStructOutput[]]>;
        poolsReservesInfo(_poolsAddresses: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<[SolidlyLensInterface.PoolReserveDataStructOutput[]]>;
        protocolMetadata(overrides?: CallOverrides): Promise<[SolidlyLensInterface.ProtocolMetadataStructOutput]>;
        ...
        vePositionsOf(accountAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[SolidlyLensInterface.PositionVeStructOutput[]]>;
    ...
    populateTransaction: {
        ...
        proxyStorageInitialized(overrides?: CallOverrides): Promise<PopulatedTransaction>;
