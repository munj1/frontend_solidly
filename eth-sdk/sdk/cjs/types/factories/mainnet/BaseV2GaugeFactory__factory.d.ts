...
import type { BaseV2GaugeFactory, BaseV2GaugeFactoryInterface } from "../../mainnet/BaseV2GaugeFactory";
export declare class BaseV2GaugeFactory__factory {
    ...
    static createInterface(): BaseV2GaugeFactoryInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): BaseV2GaugeFactory;
}
