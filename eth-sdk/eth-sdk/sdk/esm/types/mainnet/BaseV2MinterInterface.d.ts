...
export interface BaseV2MinterInterfaceInterface extends utils.Interface {
    functions: {
...
export interface BaseV2MinterInterface extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BaseV2MinterInterfaceInterface;
