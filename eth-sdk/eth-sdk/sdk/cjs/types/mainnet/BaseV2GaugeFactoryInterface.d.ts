...
export interface BaseV2GaugeFactoryInterfaceInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "childInterfaceAddress" | "childSubImplementationAddress" | "createGauge" | "governanceAddress" | "interfaceSourceAddress" | "updateChildInterfaceAddress" | "updateChildSubImplementationAddress"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "createGauge", values: [
...
export interface BaseV2GaugeFactoryInterface extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BaseV2GaugeFactoryInterfaceInterface;
    ...
    functions: {
        ...
        createGauge(_pool: PromiseOrValue<string>, _bribe: PromiseOrValue<string>, _ve: PromiseOrValue<string>, overrides?: Overrides & {
    ...
    callStatic: {
        childInterfaceAddress(overrides?: CallOverrides): Promise<string>;
        childSubImplementationAddress(overrides?: CallOverrides): Promise<string>;
        createGauge(_pool: PromiseOrValue<string>, _bribe: PromiseOrValue<string>, _ve: PromiseOrValue<string>, overrides?: CallOverrides): Promise<string>;
        governanceAddress(overrides?: CallOverrides): Promise<string>;
        interfaceSourceAddress(overrides?: CallOverrides): Promise<string>;
