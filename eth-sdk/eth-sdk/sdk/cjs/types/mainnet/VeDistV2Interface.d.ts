...
export interface VeDistV2InterfaceInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "checkpoint_token" | "checkpoint_total_supply" | "claim" | "claim_many" | "claimable" | "depositor" | "governanceAddress" | "initialize" | "last_token_time" | "setDepositor" | "start_time" | "time_cursor" | "time_cursor_of" | "timestamp" | "token" | "token_last_balance" | "tokens_per_week" | "user_epoch_of" | "ve_for_at" | "ve_supply" | "voting_escrow"): FunctionFragment;
...
export interface VeDistV2Interface extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: VeDistV2InterfaceInterface;
