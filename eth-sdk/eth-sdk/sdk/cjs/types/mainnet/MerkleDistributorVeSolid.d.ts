...
export interface MerkleDistributorVeSolidInterface extends utils.Interface {
    functions: {
        ...
        "rootTokenId()": FunctionFragment;
        "token()": FunctionFragment;
        "transferGovernance(address)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "claim" | "claimFor" | "collectDust" | "isClaimed" | "merkleRoot" | "onERC721Received" | "rootTokenId" | "token" | "transferGovernance"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "rootTokenId", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "rootTokenId", data: BytesLike): Result;
...
export interface MerkleDistributorVeSolid extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MerkleDistributorVeSolidInterface;
    ...
    functions: {
        ...
        rootTokenId(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    filters: {
        "Claimed(uint256,address,uint256,uint256)"(index?: null, account?: null, tokenId?: null, amount?: null): ClaimedEventFilter;
        Claimed(index?: null, account?: null, tokenId?: null, amount?: null): ClaimedEventFilter;
    };
    estimateGas: {
        claim(index: PromiseOrValue<BigNumberish>, account: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, merkleProof: PromiseOrValue<BytesLike>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
    ...
    populateTransaction: {
        ...
        rootTokenId(overrides?: CallOverrides): Promise<PopulatedTransaction>;
