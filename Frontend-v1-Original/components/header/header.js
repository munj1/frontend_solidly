  ...
  return (
    <div>
      <div className={classes.headerContainer}>
        ...
        <a onClick={() => router.push('/home')} className={classes.logoContainer}>
    ...
    {chainInvalid ? (
      <div className={classes.chainInvalidError}>
        <div className={classes.ErrorContent}>
          ...
          <Button className={classes.switchNetworkBtn} variant="contained" onClick={()=>switchChain()} >Switch to { process.env.NEXT_PUBLIC_CHAINID == '421613' ? 'ARB GOERLI' : 'Arbitrum' }</Button>
        </div>
      </div>
    ) : null}
    </div>
